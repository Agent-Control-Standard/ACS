...
The normative span-name and required-attribute table is on the [Trace Events](./events.md) page. The machine-readable mapping lives at [`trace/otel-mapping.json`](../../../specification/v0.1.0/trace/otel-mapping.json). This page describes how to *use* the mapping in practice.
